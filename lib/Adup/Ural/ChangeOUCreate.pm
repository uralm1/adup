...
sub info_human {
  ...
  $r .= '<br><b>Создание</b> подразделения '.xml_escape($self->{level}).'-го уровня иерархии.';
  $r .= '<br><span class="info-attr">Наименование:</span> &laquo;'.xml_escape($self->{dept_name}).'&raquo;';
