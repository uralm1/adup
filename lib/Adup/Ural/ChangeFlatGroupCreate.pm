...
sub info_human {
  ...
  $r .= '<br><b>Создание</b> группы почтового справочника корпоративной почты.';
  $r .= '<br><span class="info-attr">Подразделение:</span> устанавливается &laquo;'.xml_escape($self->{dept_name}).'&raquo;';
